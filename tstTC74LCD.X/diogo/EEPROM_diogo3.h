...
#define EEPROM_CONFIG_PMON      0
#define EEPROM_CONFIG_TALA      1
#define EEPROM_CONFIG_TINA      2
#define EEPROM_CONFIG_ALAF      3
#define EEPROM_CONFIG_ALAH      4
#define EEPROM_CONFIG_ALAM      5
#define EEPROM_CONFIG_ALAS      6
#define EEPROM_CONFIG_ALAT      7
#define EEPROM_CONFIG_ALAL      8
#define EEPROM_CONFIG_CLKH      9
#define EEPROM_CONFIG_CLKM      10

#define EEPROM_ADDR_RECORDS     0x0E
#define EEPROM_RECORD_SIZE      5
